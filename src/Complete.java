...
public class Complete implements MouseListener {
    ...
    public void render(Graphics g)
    {
        ...
        ImageIcon complete_i = new ImageIcon("images/Icons/icon_game_complete.png");
        complete_icon = complete_i.getImage();
        g.drawImage(complete_icon, 130, 50, null);
